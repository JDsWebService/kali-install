{
	printMsg "install_razer.sh" "Installing Open Source Razer Software"

	# Install OpenRazer
	printMsg "install_razer.sh" "Installing Open Razer"
	...
	printMsg "install_razer.sh" "Installing Polychromatic"
